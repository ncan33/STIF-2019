...
array = str2double(pure_array); %convert cell array to matrix


%variable 'array' is a matrix. make a vector for each load increment:
array0 = array(:,1);
array4 = array(:,2);
array6 = array(:,3);
array8 = array(:,4);
...
eqtn = ['   y=' num2str(linear_eq(1)) 'x' num2str(linear_eq(2))];
